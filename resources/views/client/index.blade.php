...
@section('content')
    ...
    <h1 class="text-2xl font-extrabold lg:text-4xl lg:w-2/4 text-main-400" id="title">Pemira adalah <span class="text-orange-500">saksi</span> dari <br class="hidden md:block">perubahan, harapan, dan aspirasi</h1>
    <p class="text-[12px] text-main-400 lg:text-sm lg:w-4/12 w-11/12 font-medium">Saatnya untuk menentukan, untuk memilih, dan untuk merubah masa depan Institut Teknologi Sumatera bersama-sama.</p>
    <button class="w-full rounded-full bg-main-300 hover:ring-orange-200 hover:ring-2 p-4 lg:w-[244px] md:w-[244px] font-medium text-white shadow-xl shadow-orange-200 flex flex-row justify-center gap-3">Ayo Voting!<i class="block lg:hidden" data-feather="arrow-right"></i></button>
    </div>

    <div id="timeline" class="mt-[15em] mb-[10em] flex flex-col items-center justify-center text-center">
    <h1 class="text-2xl font-semibold mb-5">Jadwal</h1>
    ...
    <h1 class="text-center text-xl font-medium border-b-2 border-b-orange-300 pb-3 mt-10 text-main-400">FAQ PEMIRA ITERA</h1>
    <div class="flex flex-col gap-3 ml-5 mr-5 lg:w-5/12">
        <button class="p-3 border-2 border-orange-600 bg-white text-orange-500 rounded-lg flex flex-row justify-between gap-3 font-bold btn-toggle transition ease-in">Bagaimana cara voting? <i data-feather="chevron-down"></i>
        </button>
