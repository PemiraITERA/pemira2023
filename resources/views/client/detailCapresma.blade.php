...
@section('content')
    <section>
        ...
        <!-- section 4 - proker -->
        <div
            class="flex w-full px-10 py-16 flex-col justify-center items-center gap-10 flex-shrink-0 border-b-2 border-main-100"
        >
            <div
                class="flex items-center pb-2 border-b-[2px] border-main-200"
            >
        ...
        <div
            id="partai"
            class="flex w-full py-16 flex-col items-center gap-10"
        >
            <div
            ...
            >
                ...
                <div class="flex flex-col items-center gap-6">
                    <img src="{{ asset('storage/ormawa/'.$data->foto) }}" alt="" class="w-[80px] md:w-[100px] xl:w-[120px] h-[80px] md:h-[100px] xl:h-[120px] rounded-full ">
                    <h2
