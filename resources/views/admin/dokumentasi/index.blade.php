    ...
    <section class="section">
        <div class="card">
                    ...
                    <tbody>
                        @foreach ($dokumentasi as $data => $value)
                            <tr>
                                ...
                                <form method="POST" action="{{route('admin.dokumentasi.destroy', $value->id)}}"  enctype='multipart/form-data' style="display: inline-block">
                                    @method('DELETE')
                                    @csrf
            ...
            <div class="card-footer clearfix">
                {{ $dokumentasi->links('vendor.pagination.bootstrap-5') }}
            </div>
        </div>
